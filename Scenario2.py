...
def get_reward(cell_type, is_terminal):
    if is_terminal and cell_type > 0:
        return 100  # Final package collected
    elif cell_type > 0:
        return 25  # Intermediate package collected
...
def main():
    ...
    log_file_path = os.path.join("logs", "scenario2_log.txt")
    ...
    fourRoomsObj.showPath(-1, savefig="./plots/scenario2_path.png")
    ...
    plt.savefig("./plots/scenario2_rewards.png")
    plt.close()
